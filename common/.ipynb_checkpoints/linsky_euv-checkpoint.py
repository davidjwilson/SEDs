...
20220920 adding treatment for F and K stars

"""

def euv_estimator(lya, distance, star='', save=False, plot=False, spt='M'):
    ...
    if spt == 'M':
        ...
        a = np.array([-1.357,-1.300,-0.882,-2.294,-2.098,-1.920,-1.894,-1.811,-1.004], dtype=float)
        b = np.array([ 0.344,    0.309,    0.,    0.258, 0.572, 0.240, 0.518, 0.764, 0.065], dtype=float)
